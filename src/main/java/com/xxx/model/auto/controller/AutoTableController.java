package com.xxx.model.auto.controller;

import com.alibaba.fastjson.JSON;
import com.xxx.common.auto.bean.Column;
import com.xxx.common.auto.bean.Table;
import com.xxx.common.auto.constant.AutoInfoConstant;
import com.xxx.common.auto.util.CamelCaseUtils;
import com.xxx.common.auto.util.FileHelper;
import com.xxx.common.auto.util.MySqlTools;
...
import com.xxx.model.auto.service.AutoTableService;
import com.xxx.model.auto.vo.req.AutoTableReq;
...
public class AutoTableController extends BaseController {
	...
	public String createAutoFile(Model model,AutoTableReq autoTableReq) throws Exception {
		...
		if(autoTableReq.getCreateType() == 1){
			...
			sysMenu.setIsShow(1);
			sysMenu.setLevel(3);
			sysMenu.setName(autoTableReq.getInfo());
