package com.xxx.model.auto.vo.req;
...
public class AutoTableReq {
    ...
    public void setAutoTableColumns(List<AutoTableColumn> autoTableColumns) { this.autoTableColumns = autoTableColumns; }

    public String getOutRoot() { return outRoot; }
    ...
    public Integer getCreateType() { return createType; }
