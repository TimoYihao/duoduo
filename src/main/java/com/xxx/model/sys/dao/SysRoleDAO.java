...
public interface SysRoleDAO {
    ...
    @Select("select sys_role.id from sys_role where sys_role.id in (select sys_user_role.sys_role_id from sys_user_role where sys_user_role.sys_user_id = #{userId}) and sys_role.status = 1")
