            ...
            <form id="searchForm" class="layui-form" method="post" style="margin-top: 20px;">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <input  type = "text" name="transfer" value="${(deliver.transfer)!}" placeholder="转交人" class="layui-input" />
                    </div>
                    <div class="layui-inline">
                        <input  type = "text" name="receive" value="${(deliver.receive)!}" placeholder="接收人" class="layui-input" />
                    </div>
                    <div class="layui-inline">
        ...
        <script>
            layui.use(['form','laydate','laypage','layer','upload'],function(){
                ...
                layui.showInfo = function(id){
                    layui.save("查看客户转交",id);
                }

                //编辑
                layui.edit = function(id){
                    layui.save("编辑客户转交",id)
                }
                ...
                layui.save = function(title,id){
                    var url ='${springMacroRequestContext.contextPath}/deliver/saveFrom';
                ...
                layui.accredit = function(id,status){
                    ...
                    layer.msg(title, {
                        btn: b,
                        yes:function(){
                            window.location.href="${springMacroRequestContext.contextPath}/deliver/accredit?id="+id+"&status="+status;
                        }
                    });
                }
                ...
                layui.del = function(id){
                    layer.msg("您是否确定要删除该客户转交！", {
                        btn: ['确定', '取消'],
                        yes:function(){
                            window.location.href="${springMacroRequestContext.contextPath}/deliver/delById?id="+id;
                        }
                    });
                }
            });
