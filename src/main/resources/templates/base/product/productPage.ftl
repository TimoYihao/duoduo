            ...
            <form id="searchForm" class="layui-form" method="post" style="margin-top: 20px;">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <input  type = "text" name="name" value="${(product.name)!}" placeholder="产品名称" class="layui-input" />
                    </div>
                    <div class="layui-inline">
                        <select name="halt">
                            <option value="">停售状态</option>
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        <td>${(entity_index+1)!}</td>
                                ...
                                <td><@common.mdictInfo title='halt' value='${(entity.halt)!}' /></td>
                        <@common.permission per='base:product:edit'>
                        <td>
        ...
        <script>
            layui.use(['form','laydate','laypage','layer','upload'],function(){
                ...
                layui.showInfo = function(id){
                    layui.save("查看产品管理",id);
                }

                //编辑
                layui.edit = function(id){
                    layui.save("编辑产品管理",id)
                }
                ...
                layui.save = function(title,id){
                    var url ='${springMacroRequestContext.contextPath}/product/saveFrom';
                ...
                layui.accredit = function(id,status){
                    ...
                    layer.msg(title, {
                        btn: b,
                        yes:function(){
                            window.location.href="${springMacroRequestContext.contextPath}/product/accredit?id="+id+"&status="+status;
                        }
                    });
                }
                ...
                layui.del = function(id){
                    layer.msg("您是否确定要删除该产品管理！", {
                        btn: ['确定', '取消'],
                        yes:function(){
                            window.location.href="${springMacroRequestContext.contextPath}/product/delById?id="+id;
                        }
                    });
                }
            });
