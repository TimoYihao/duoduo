            ...
            <form id="searchForm" class="layui-form" method="post" style="margin-top: 20px;">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <input  type = "text" name="department" value="${(review.department)!}" placeholder="所属部门" class="layui-input" />
                    </div>
                    <div class="layui-inline">
                        <input  type = "text" name="number" value="${(review.number)!}" placeholder="合同编号" class="layui-input" />
                    </div>
                    <div class="layui-inline">
                        <select name="visit">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        <td>${(entity_index+1)!}</td>
                                ...
                                <td>${(entity.number)!}</td>
                                <td><@common.mdictInfo title='visit' value='${(entity.visit)!}' /></td>
                                <td><@common.mdictInfo title='result' value='${(entity.result)!}' /></td>
        ...
        <script>
            layui.use(['form','laydate','laypage','layer','upload'],function(){
                ...
                layui.showInfo = function(id){
                    layui.save("查看客户回访",id);
                }

                //编辑
                layui.edit = function(id){
                    layui.save("编辑客户回访",id)
                }
                ...
                layui.save = function(title,id){
                    var url ='${springMacroRequestContext.contextPath}/review/saveFrom';
                ...
                layui.accredit = function(id,status){
                    ...
                    layer.msg(title, {
                        btn: b,
                        yes:function(){
                            window.location.href="${springMacroRequestContext.contextPath}/review/accredit?id="+id+"&status="+status;
                        }
                    });
                }
                ...
                layui.del = function(id){
                    layer.msg("您是否确定要删除该客户回访！", {
                        btn: ['确定', '取消'],
                        yes:function(){
                            window.location.href="${springMacroRequestContext.contextPath}/review/delById?id="+id;
                        }
                    });
                }
            });
