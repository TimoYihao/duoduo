            ...
            <form id="searchForm" class="layui-form" method="post" style="margin-top: 20px;">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <input  type = "text" name="department" value="${(salesplan.department)!}" placeholder="所属部门" class="layui-input" />
                    </div>
                    <div class="layui-inline">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        <td>${(entity_index+1)!}</td>
                                ...
                                <td>${(entity.sum)!}</td>
                                <td><#if entity.time?? >${entity.time?string("yyyy年MM月dd日 HH:mm:ss")}</#if></td>
        ...
        <script>
            layui.use(['form','laydate','laypage','layer','upload'],function(){
                ...
                layui.showInfo = function(id){
                    layui.save("查看销售计划",id);
                }

                //编辑
                layui.edit = function(id){
                    layui.save("编辑销售计划",id)
                }
                ...
                layui.save = function(title,id){
                    var url ='${springMacroRequestContext.contextPath}/salesplan/saveFrom';
                ...
                layui.accredit = function(id,status){
                    ...
                    layer.msg(title, {
                        btn: b,
                        yes:function(){
                            window.location.href="${springMacroRequestContext.contextPath}/salesplan/accredit?id="+id+"&status="+status;
                        }
                    });
                }
                ...
                layui.del = function(id){
                    layer.msg("您是否确定要删除该销售计划！", {
                        btn: ['确定', '取消'],
                        yes:function(){
                            window.location.href="${springMacroRequestContext.contextPath}/salesplan/delById?id="+id;
                        }
                    });
                }
            });
