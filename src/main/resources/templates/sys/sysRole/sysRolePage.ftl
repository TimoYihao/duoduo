					...
					<tbody>
						<#list pager.list as entity>
							<tr>
								...
								<@common.permission per='sys:sysRole:edit'>
									<td>
										<a href="javascript:;" onclick="layui.edit('${(entity.id)!}')" class="layui-btn layui-btn-xs">编辑</a>
										<a href="javascript:;" onclick="layui.accredit('${(entity.id)!}','${(entity.status)!}')" class="layui-btn layui-btn-danger layui-btn-xs">
